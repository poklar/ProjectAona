...
using ProjectAona.Engine.Chunks.Generators;
...
namespace ProjectAona.Engine.Chunks
{
    ...
    public class ChunkCache
    {
        ...
        public void LoadChunks(Chunk[,] chunks, int ratioWidth, int ratioHeight)
        {
            ...
            for (int x = 0; x < ratioWidth; x++)
            {
                ...
                {
                    _chunkGenerator.BuildChunk(chunks[x, y]);
                    ChunkStorage[new Point(x, y)] = chunks[x,y];
                }
            }
        }
